    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/users", "/users/login", "/users/create", "/users/PromoteUser", "/users/EditUserProfile","/users/DeleteUser", "/users/ToggleUserEnabled", "/create", "/message/ChatCreate", "/message/MessageCreate", "/message", "transaction/TransactionCreate", "transaction/UpdateTransactionStatus").permitAll()
