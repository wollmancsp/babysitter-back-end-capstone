    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/login", "/create", "/error", "/users", "users/RandomSearchByCity", "users/FindByUserID/**", "/users/SearchByCity/**", "/users/ReturnPfp/**", "/message/FindAllChats/**", "users/GetUserIDs/**", "/message/MessageCreate", "/message/UpdateChat/**", "/transaction", "transaction/GetTransactionsByUserID/**", "/profilePicture/**", "/**").permitAll() // Allow unrestricted access to home page
